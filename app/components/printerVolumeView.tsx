...
export const PRINTER_VOLUME_VIEW = ({ scene }: { scene: PrinterScene }) => {
  let homeDiv: HTMLDivElement;
  homeDiv = null;
  const view = <div ref={homeDiv} class="render-target"></div>;
  const printerVolumeView = new PrinterVolumeView(homeDiv, scene);
  return view;
};
